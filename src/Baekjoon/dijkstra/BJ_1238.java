 ...
 * <br>
 * <a href = "https://velog.io/@jky00914/%EB%B0%B1%EC%A4%80-1238%EB%B2%88-%ED%8C%8C%ED%8B%B0">velog</a>
 * @since 2024-06-26
 */
public class BJ_1238 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int[] distFromX = dijkstra(n, graph, x); //도착지 x 에서 각 마을로 가는 최단 거리
        int[] distToX = dijkstra(n, reversedGraph, x); //각 마을에서 도착지 x로 가는 최단 거리
